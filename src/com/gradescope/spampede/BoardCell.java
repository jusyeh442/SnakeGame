...
public class BoardCell {
	...
	public boolean isOpen() {
		return this.myCellType == CellType.OPEN || this.isSpam() || this.isHyperspace();
	}
	...
	/** @return Does this cell contain hyperspace? */
	public boolean isHyperspace() {
		return this.myCellType == CellType.SPACE;
	}
	...
	public Color getCellColor(){
		if (this.isWall()) {
			...
			return Preferences.COLOR_SPACE;
		} else if (this.isOpen()) {
	...
	/** Marks this BoardCell as hyperspace. */
	public void becomeHyperspace() {
		this.myCellType = CellType.SPACE;
	}
